...
import { Fn, MapSources, MapOldSources } from '../utils/types'
import { createFilterWrapper, bypassFilter } from '../utils/filters'
...
export function ignorableWatch<T, Immediate extends Readonly<boolean> = false>(
